...
from botify.recommenders.myRecommender import MyRecommender
...
tracks_to_users_redis = Redis(app, config_prefix="REDIS_TRACKS_TO_USERS")
...
catalog.upload_tracks_to_users(tracks_to_users_redis.connection)
