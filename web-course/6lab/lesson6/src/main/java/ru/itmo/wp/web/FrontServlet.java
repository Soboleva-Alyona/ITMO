...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        if (route.getAction().equals("before") || route.getAction().equals("after")) {
            throw new ServletException("Bad action name");
        }

        Map<String, Object> view = new HashMap<>();
        putUser(request, view);
        List<String> methodsNames = List.of("before", route.getAction(), "after");
    ...
    private Method findMethod(Class<?> pageClass, String name) throws NotFoundException {
        Method method = null;
