...
public class Page {
    ...
    private static final String BAD_MESSAGE_SESSION_KEY = "badMessage";
    ...
    @ModelAttribute("badMessage")
    public String getBadMessage(HttpSession httpSession) {
        String message = (String) httpSession.getAttribute(BAD_MESSAGE_SESSION_KEY);
        httpSession.removeAttribute(BAD_MESSAGE_SESSION_KEY);
        return message;
    }
    ...
    void unsetUser(HttpSession httpSession) {
        putMessage(httpSession,"Good bye, " + getUser(httpSession).getLogin());
    ...
    public void putBadMessage(HttpSession httpSession, String badMessage) {
        httpSession.setAttribute(BAD_MESSAGE_SESSION_KEY, badMessage);
    }
